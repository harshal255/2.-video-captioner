...
export default function Footer() {
  return (
    <footer className="w-full py-6 text-center text-[10px] text-zinc-500 border-t border-zinc-955 mt-auto bg-zinc-950/30 flex flex-col gap-2.5 items-center z-10">
